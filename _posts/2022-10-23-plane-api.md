---
title: Printing Weather API
layout: default
description: An example of my own API organization.
...
<form method="POST">
  <p>Select Flight Number</p>
      <input type="text" id="flight" value="">
  ...
  <script>
      function myFunction() {
          var x = document.getElementById("flight").value;
          var y = document.getElementById("date").value;
          document.getElementById("demo").innerHTML = "Flight: " + x + " Date: " + y;
      }
  </script>
</form>
